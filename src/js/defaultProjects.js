...
projectCount++;
let sampleObj = Todo('Default Task', 'Default Description', "2022-02-01 @ 14:12PM", "High", 50);
...
let sampleObj2 = Todo('Today Task', 'Default Description', "2022-02-01 @ 14:12PM", "High", 50);
...
let sampleObj3 = Todo('Week Task', 'Default Description', "2022-02-01 @ 14:12PM", "High", 50);
