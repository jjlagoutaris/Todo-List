...
projectCount++;
let sampleObj = Todo('Default Task', 'Default Description', "2022-03-16T03:52", "High", 20);
...
let sampleObj2 = Todo('Today Task', 'Default Description', "2022-03-16T03:52", "High", 30);
